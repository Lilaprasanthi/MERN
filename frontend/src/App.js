...
const stripePromise = loadStripe(
  "pk_test_51OyvQiSGPt9vjUcMjKyKpmND0n1lXZ3YbU8PUNGLUU3ophewRyyiUKS8fttNFWbdMvv0LbWqg8QWNZyVGPTJdyab00Het6uY7q");

  // define our usedispatch
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      ...
      // exact properties ensures that the route matches exactly what u gave in path
      ...
      <Route path="/" element={<Main/>} id="main" exact>
        ...
        />
           ...
           <Route id='updateprofile' path='user/updateprofile' element={<UpdatePassword />} />
           ...
           <Route id='bookingdetails' path='user/booking/:bookingId' element={<BookingDetails />}  /></Route>
    )
  );
  return (
    <div className="App">
      {/* this ensures that the routing functionality is available throught the application  */}
